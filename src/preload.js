...
contextBridge.exposeInMainWorld('api', {
    ...
    getAdminRfids: () => ipcRenderer.invoke('get-admin-rfids'),
    addAdminRfid: (code, name) => ipcRenderer.invoke('add-admin-rfid', code, name),
    deleteAdminRfid: (code) => ipcRenderer.invoke('delete-admin-rfid', code),
